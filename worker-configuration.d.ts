/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0a3539210a04008ce44cc48691e8fdbb)
// Runtime types generated with workerd@1.20250803.0 2025-08-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		KV: KVNamespace;
		PROXY_FALLBACK_STATUSES: "403,407,408,409,425,429,451,503,520,521,522,523,524";
		ALLOW_UNAUTH_IMPORT_MEDIA: "1";
		METADATA_DOMAIN_THROTTLE: DurableObjectNamespace<import("./src/index").MetadataDomainThrottle>;
		R2: R2Bucket;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROXY_FALLBACK_STATUSES" | "ALLOW_UNAUTH_IMPORT_MEDIA">> {}
}
